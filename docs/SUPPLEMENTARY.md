...
本節では、論文内で紙幅の都合上詳述できなかった共進化型（Co-evolution）**および**非対話型（No Interaction）の代表的な事例について、トピックの内容（キーワード・代表記事）と時系列統計量の双方から詳細に解説します。各トピックのタイトルや要約は、Gemini 2.5 flashでFREXや代表記事を参照しながら自動的かつ便宜的に付与したものです。
